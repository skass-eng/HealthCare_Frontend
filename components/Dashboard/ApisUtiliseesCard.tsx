/**
 * Composant pour afficher les APIs utilisées par page
...
interface ApisUtiliseesCardProps {
  className?: string;
}
...
export default function ApisUtiliseesCard({ className = '' }: ApisUtiliseesCardProps) {
